    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            while (true)
            {
                ...
                var packet = PacketBindings.DecodePacket(input);
                var output = PacketBindings.EncodePacket(packet);

                var packetCheck = PacketBindings.DecodePacket(output);
                var outputCheck = PacketBindings.EncodePacket(packetCheck);
