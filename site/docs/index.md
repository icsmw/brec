...
- **Optional resilient compatibility** - Enable the `resilient` feature to let older readers skip unknown blocks and payloads during protocol evolution (see [resilient compatibility](features/resilient.md)).
