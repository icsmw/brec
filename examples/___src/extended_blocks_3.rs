...
impl<'a> brec::ReadBlockFromSlice for CustomBlockReferred<'a> {
        ...
        Self: 'b + Sized,
    {
        ...
        let crc = __crc;
        let block: CustomBlockReferred<'b> = CustomBlockReferred {
            __sig,
            field_u8,
            field_u16,
            field_u32,
        ...
        let block: CustomBlockReferred<'a> = unsafe { std::mem::transmute(block) };
        Ok(block)
    }
}
